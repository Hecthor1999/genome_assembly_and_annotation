...
dat <- fread("/data/users/harribas/assembly_course/annotation/scripts/genespace/orthofinder/Results_Nov15/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
orthogroups <- fread("/data/users/harribas/assembly_course/annotation/scripts/genespace/orthofinder/Results_Nov15/Orthogroups/Orthogroups.GeneCount.tsv")
