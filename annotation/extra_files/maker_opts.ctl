...
est=/data/users/harribas/assembly_course/assembly/results_trinity/results_trinity.Trinity.fasta
altest= #EST/cDNA sequence file in fasta format from an alternate organism
est_gff= #aligned ESTs or mRNA-seq from an external GFF3 file
altest_gff= #aligned ESTs from a closly relate species in GFF3 format

#-----Protein Homology Evidence (for best results provide a file for at least one)
protein=/data/courses/assembly-annotation-course/CDS_annotation/data/TAIR10_pep_20110103_representative_gene_model, /data/courses/assembly-annotation-course/CDS_annotation/data/uniprot_viridiplantae_reviewed.fa
protein_gff=  #aligned protein homology evidence from an external GFF3 file

#-----Repeat Masking (leave values blank to skip repeat masking)
model_org= #select a model organism for DFam masking in RepeatMasker
rmlib=/data/users/harribas/assembly_course/annotation/output/EDTA_annotation/assembly.fasta.mod.EDTA.TElib.fa
